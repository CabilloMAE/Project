...
public class regForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/Manang.jpg"))); // NOI18N
        ...
        if(em.getText().isEmpty()||ln.getText().isEmpty()||un.getText().isEmpty()||ps.getText().isEmpty()){
            ...
            try{    
                String pass = passwordHash.hashPassword(ps.getText());
                 ...
                 if(dbc.insertData("INSERT INTO  tbl_user (u_fname, u_lname, u_email, u_username, "
                         + " u_password, u_type, u_status) VALUES ('"+fn.getText()+"', '"
